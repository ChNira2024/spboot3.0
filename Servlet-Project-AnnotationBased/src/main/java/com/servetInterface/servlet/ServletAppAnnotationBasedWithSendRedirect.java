...
@WebServlet("/servlet-application-withsr")
public class ServletAppAnnotationBasedWithSendRedirect implements Servlet
{
	...
	public void service(ServletRequest req, ServletResponse resp) throws ServletException, IOException 
	{
		...
		pwo.print("From SR,Hi "+username + "<br>");
		pwo.print("<a href=\"loginForSR.html\">Go to Login For SR</a>");
